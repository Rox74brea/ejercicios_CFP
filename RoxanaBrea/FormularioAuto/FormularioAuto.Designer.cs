...
namespace FormularioAuto
{
    partial class FormularioAuto
    {
        ...
        private void InitializeComponent()
        {
            ...
            btn_Ok.Location = new Point(47, 320);
            ...
            lst_AutosIngresados.Location = new Point(258, 76);
            ...
            lst_AutosIngresados.Size = new Size(585, 277);
            ...
            lbl_tituloLista.Location = new Point(258, 51);
            ...
            // btn_limpiar_datos
            // 
            btn_limpiar_datos.BackColor = Color.FromArgb(0, 192, 192);
            btn_limpiar_datos.Location = new Point(566, 361);
            btn_limpiar_datos.Margin = new Padding(4);
            btn_limpiar_datos.Name = "btn_limpiar_datos";
            btn_limpiar_datos.Size = new Size(147, 33);
            btn_limpiar_datos.TabIndex = 9;
            btn_limpiar_datos.Text = "Limpiar Datos";
            btn_limpiar_datos.UseVisualStyleBackColor = false;
            btn_limpiar_datos.Click += btn_limpiar_datos_Click;
            // 
            // btn_mostrar_datos
            // 
            btn_mostrar_datos.BackColor = Color.FromArgb(255, 192, 128);
            btn_mostrar_datos.Location = new Point(340, 362);
            btn_mostrar_datos.Margin = new Padding(4);
            btn_mostrar_datos.Name = "btn_mostrar_datos";
            btn_mostrar_datos.Size = new Size(139, 33);
            btn_mostrar_datos.TabIndex = 10;
            btn_mostrar_datos.Text = "Mostrar Datos";
            btn_mostrar_datos.UseVisualStyleBackColor = false;
            btn_mostrar_datos.Click += btn_mostrar_datos_Click;
            // 
            // FormularioAuto
            // 
            ...
            ClientSize = new Size(856, 427);
            Controls.Add(btn_mostrar_datos);
            Controls.Add(btn_limpiar_datos);
